...
import type { AutoTagResult, ContentType } from '@/types';
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <p className="text-sm text-slate-400">
              PDF, PPTX, DOCX, XLSX, MP4, PNG, JPG, GIF, SVG — max 100 MB
            </p>
            {file && (
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              {step === 'uploading'
                ...
                : 'Extracting text and generating tags with Claude'}
            </p>
          </div>
          {step === 'uploading' && (
      ...
      {step === 'review' && tags && (
        <div className="space-y-5">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="font-semibold text-slate-900 text-sm">AI tagging complete</p>
              <p className="text-xs text-slate-500">
                Confidence: {Math.round((tags.confidence_score ?? 0) * 100)}% — Review and edit below
              </p>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {mergedTags.industry_tags.map((t) => (
                    <span key={t} className="px-2 py-0.5 bg-blue-50 text-blue-700 rounded-full text-xs">
                      {t}
                    </span>
                  ))}
                </div>
          ...
          <div className="flex gap-2 pt-1">
            <Button variant="outline" onClick={() => { setStep('select'); setFile(null); setTags(null); }} className="flex-1">
